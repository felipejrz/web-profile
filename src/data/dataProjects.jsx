...
export const profileData = [
  {
    titulo: "Pokedex: Plataforma Avanzada de Gestión y Análisis de Información Pokémon",
    imagen: "/page-pokemon.png",
    ...
    listChips: [
      ...
      { label: "Github Pages", icon: <Icons.SiGithubpages />, variant: "outlined", color: "#BBDDE5" },
    ],
  ...
  },
  {
    ...
    listChips: [
      { label: "React", icon: <Icons.FaReact />, variant: "outlined", color: "#61DAFB" },
      { label: "MUI", icon: <Icons.SiMui />, variant: "outlined", color: "#007FFF" },
      { label: "Node.js", icon: <Icons.FaNodeJs />, variant: "outlined", color: "#5FA04E" },
      { label: "Vite.js", icon: <Icons.SiVite />, variant: "outlined", color: "#646CFF" },
      { label: "Framer Motion", icon: <Icons.SiFramer />, variant: "outlined", color: "#0055FF" },
      { label: "Locomotive Scroll", icon: <Icons.GiSteamLocomotive />, variant: "outlined", color: "#d4c9c9" },
    ],
    linkPages: "https://felipejrz.github.io/pokemon-zeiropedia/",

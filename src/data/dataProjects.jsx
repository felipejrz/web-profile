...
export const profileData = [
  ...
  {
    titulo: "Tienda: Encuentra Todo lo que Necesitas",
    imagen: "/assets/shop-page.png", // Ruta absoluta desde public
    texto:
      "Nuestra tienda es la solución perfecta para descubrir y adquirir los productos que deseas. Ofrecemos una amplia variedad, desde tecnología hasta hogar, con descripciones detalladas, opiniones de clientes y ofertas exclusivas, todo en una plataforma intuitiva y fácil de usar.",
    listChips: [
      {
        label: "Angular",
        icon: <FaReact />,
    ...
    linkPages: "https://felipejrz.github.io/pokemon-zeiropedia/",
    linkHub: "https://github.com/felipejrz/signal-store",
  },
  {
